...
export default function AboutPage() { return <PageShell active="about">
  ...
  <p className="lede">
    J Bells has been repairing phones in Trivandrum since 2010. Whether it’s a broken screen, charging problem, battery issue, or something that just isn’t working right, we first find out what’s wrong and explain it to you before we start the repair.
  </p>
</section>
